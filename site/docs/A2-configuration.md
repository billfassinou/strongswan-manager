...
|---|---|---|
| `HTTP_ADDR` | `:8080` | Adresse et port d'écoute du serveur HTTP. |
...
| `CRL_URL` | *(vide)* | URL publique de la CRL, **inscrite dans les certificats émis** (CRL Distribution Point). Ex. `http://mon-serveur:8080/crl.der`. Doit être définie **avant** d'émettre des certificats. |
